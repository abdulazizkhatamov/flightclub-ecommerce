...
const HomePage: React.FC = () => {
  const isDesktop = useIsDesktop(768); // You can change the breakpoint if needed
  ...
  return (
    <main>
      <section className="relative flex items-end justify-center h-[90vh] lg:h-screen sm:justify-start">
        ...
        <div className="max-w-[940px] inset-0 absolute w-full h-full flex items-center mx-auto text-left justify-start lg:max-w-[1800px] px-[50px]">
          <div
            className={
              "z-[900] lg:p-0 lg:max-w-[38rem] text-center lg:text-left"
            }
          >
            <h1
              className={
